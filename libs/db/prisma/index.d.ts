...
export namespace Prisma {
  ...
  */
    ...
    model: {
      entry: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.entryFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.entryAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type entryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "content" | "name" | "parent" | "type", ExtArgs["result"]["entry"]>
  ...
  export interface entryDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Entries that matches the filter.
     * @param {entryFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const entry = await prisma.entry.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: entryFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Entry.
     * @param {entryAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const entry = await prisma.entry.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: entryAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface entryFieldRefs {
    ...
    readonly parent: FieldRef<"entry", 'String'>
   ...
   * entry findRaw
   */
  export type entryFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
   ...
   * entry aggregateRaw
   */
  export type entryAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export type entryWhereInput = {
    ...
    parent?: StringNullableFilter<"entry"> | string | null
  ...
  export type entryScalarWhereWithAggregatesInput = {
    ...
    parent?: StringNullableWithAggregatesFilter<"entry"> | string | null
